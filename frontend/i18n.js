(() => {
  ...
  const exactTranslations = new Map(Object.entries({
    ...
    "正在移出…": "Removing…",
    "恢复中…": "Restoring…",
    "后端在线 · 真实模型": "Backend online · production models",
  ...
  const patternTranslations = [
    ...
    [/^0\.65 Mutual Top-(\d+)、(\d+)-core 与最大连通分量的最终去留$/, "Final keep/exclude result from 0.65 Mutual Top-$1, $2-core, and the largest connected component"],
